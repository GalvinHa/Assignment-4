...
private:
	...
	//private helpers mergesort
	Node<ItemType>* mergeSortedLists(Node<ItemType>* left, Node<ItemType>* right);
	Node<ItemType>* mergeSortNodes(Node<ItemType>* head);
	//private helpers quicksort
